...
async def generate_str_draft(
    ...
    str_draft = {
        ...
        "grounds_of_suspicion": txn_dict.get("fraud_reason", case_dict.get("investigation_report", "See attached investigation report")),
        ...
        "declaration": "I hereby certify that the information given above is true and correct to the best of my knowledge and belief. This STR is filed in compliance with Prevention of Money Laundering Act, 2002.",

        "status": "DRAFT — Pending Analyst Review",
        "generated_at": now.isoformat(),
        "generated_by": "Horizon AI Investigation System v1.0",
    }
